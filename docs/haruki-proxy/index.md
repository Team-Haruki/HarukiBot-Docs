...
![img.png](../assets/haruki-proxy-pc/目录.png)
...
1. 按理来说，在安装时mumu模拟器会自动在你的桌面创建一个快捷方式,如果你删除了这个快捷方式，那么请查看结尾的处理方式
   ![114514](../assets/haruki-proxy-pc/114514.png)

2. 接下来，右键这个快捷方式，并在接下来弹出的菜单中选择“打开文件所在的位置”
   ![735ac4dcdc2d463bf7b85ea36843194e](../assets/haruki-proxy-pc/735ac4dcdc2d463bf7b85ea36843194e.png)
   接下来你就会跳转到mumu模拟器安装的目录,系统会用蓝色标识出快捷方式连接到的“MuMuNxMain.exe”
   ![1919](../assets/haruki-proxy-pc/1919.png)
...
3. 打开你的MuMu模拟器，在你的虚拟机左上角，应该会有一个#x的编号
   ![810](../assets/haruki-proxy-pc/810.png)
   将
...
1. 单击键盘上的windows键，这时候你的开始菜单应该弹出来了
   ![FFFF](../assets/haruki-proxy-pc/FFFF.jpg)
   ...
   ![6666](../assets/haruki-proxy-pc/6666.png)

2. 如果你的操作系统宣称自己比较先进（是`win11`）那么你就只能使用搜索了(
   虽然这个win10也一样可以用），直接点击任务栏里那个神秘放大镜进入搜索菜单，搜索MuMu模拟器，然后直接点击打开文件位置，和之前一样操作
   ![e0912df36e19459421e61be8e5a9bf12](../assets/haruki-proxy-pc/e0912df36e19459421e61be8e5a9bf12.png)  
   ![cea2565c1b3c760370e3c79838c7f097](../assets/haruki-proxy-pc/cea2565c1b3c760370e3c79838c7f097.png)
...
![185dc324e9ac19c2ffbf2e0f0f5bf9bc](../assets/haruki-proxy-pc/185dc324e9ac19c2ffbf2e0f0f5bf9bc.png)
...
![img.png](../assets/haruki-proxy-pc/首次启动.png)
...
![suite.png](../assets/haruki-proxy-pc/suite.png)

### mysekai数据

打开mysekai，等到你的豆腐人走出房门，看到如下提示，那么Mysekai数据抓取就顺利完成了

![mysekai.png](../assets/haruki-proxy-pc/mysekai.png)
...
![c3a3a31b5274f9cd5dac44856f199d48](../assets/haruki-proxy-pc/c3a3a31b5274f9cd5dac44856f199d48.png)

接着，在弹出的界面中输入ipconfig，从出现的内容中找到`以太网适配器 以太网` 或 `无线局域网适配器 WLAN`，下方的IPV4/IPV6地址即为你的当前地址

![f4f0917014e30f5eebc6dde4c67d57a8](../assets/haruki-proxy-pc/f4f0917014e30f5eebc6dde4c67d57a8.png)
...
![a4aad736ea0ffb5b92d7e02778cafa4d](../assets/haruki-proxy-pc/a4aad736ea0ffb5b92d7e02778cafa4d.png)
...
![0a70e59e05b165336ec63e8689e45e20](../assets/haruki-proxy-pc/0a70e59e05b165336ec63e8689e45e20.png)
